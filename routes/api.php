...
Route::group(['middleware' => 'laravel.jwt', 'namespace' => 'Api'], function() {
    ...
    Route::patch('lists/{list_id}', 'ListsController@show');
    Route::delete('lists/{list_id}', 'ListsController@show');
    ...
    Route::delete('members/{list_id}/{subscriberHash}', 'MembersController@delete');
});
